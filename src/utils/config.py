...
OS2AUTOPROCES_XAPI_URL = os.getenv('OS2AUTOPROCES_XAPI_URL', None)

GITHUB_ACCESS_TOKEN = os.getenv('GITHUB_ACCESS_TOKEN', None)
GITHUB_API_URL = os.getenv('GITHUB_API_URL', None)
GITHUB_PROJECT_ID = os.getenv('GITHUB_PROJECT_ID', None)
GITHUB_ORG = os.getenv('GITHUB_ORG', None)
GITHUB_OS2AUTOPROCES_FIELD_ID = os.getenv('GITHUB_OS2AUTOPROCES_FIELD_ID', None)
